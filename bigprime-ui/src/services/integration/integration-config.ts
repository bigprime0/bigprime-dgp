...
export namespace IntegrationConfigService {
  ...
  export const getTreeList = async () => {
    const res = await request.post('/bigprime-dgp/integration/config/category/tree')
    return res.data as integrationCategoryInfo[]
  }

  export const saveCategory = async (param: integrationCategoryInfo) => {
    const res = await request.post('/bigprime-dgp/integration/config/category/save', param)
    return res.data as number
  }

  export const deleteCategory = async (id: number) => {
    const res = await request.delete('/bigprime-dgp/integration/config/category/' + id)
    return res.data as number
  }

  export const getDetailPageList = async (params: any) => {
    const res = await request.post('/bigprime-dgp/integration/config/detail/page', params)
    return res.data as integrationConfigDetail[]
  }

  export const getDetailList = async () => {
    const res = await request.get('/bigprime-dgp/integration/config/detail/list')
    return res.data as integrationConfigDetail[]
  }

  export const saveDetail = async (param: integrationConfigDetail) => {
    const res = await request.post('/bigprime-dgp/integration/config/detail/save', param)
    return res.data as boolean
  }

  export const updateDetail = async (param: integrationConfigDetail) => {
    const res = await request.put('/bigprime-dgp/integration/config/detail/update', param)
    return res.data as boolean
  }

  export const deleteDetail = async (id: number) => {
    const res = await request.delete(`/bigprime-dgp/integration/config/detail/${id}`)
    return res.data as boolean
  }

  export const getGlobalConfigList = async () => {
    const res = await request.get('/bigprime-dgp/integration/config/global/list')
    return res.data as integrationGlobalConfig[]
  }

  export const saveGlobalConfig = async (param: integrationGlobalConfig[]) => {
    const res = await request.post('/bigprime-dgp/integration/global/config/save', param)
    return res.data as number
  }

  export const getJobPageList = async (params: any) => {
    const res = await request.post('/bigprime-dgp/integration/job/page', params)
    return res.data as integrationJob[]
  }

  export const saveJob = async (params: integrationJob) => {
    const res = await request.post('/bigprime-dgp/integration/job/save', params)
    return res.data as boolean
  }

  export const deleteJob = async (id: number) => {
    const res = await request.delete(`/bigprime-dgp/integration/job/${id}`)
    return res.data as boolean
  }

  export const submitJob = async (params: integrationJob) => {
    const res = await request.post('/bigprime-dgp/integration/job/submit', params)
    return res.data as any
  }

  export const getJobLogPageList = async (params: any) => {
    const res = await request.post('/bigprime-dgp/integration/job/log/page', params)
    return res.data as integrationJobLog[]
  }

  export const getMasterDataWriter = async (params: any) => {
    const res = await request.post('/bigprime-dgp/integration/master/writer', params)
    return res.data as {}
  }

  export const saveAndSubmitJob = async (params: integrationJob) => {
    const res = await request.post('/bigprime-dgp/integration/job/save-submit', params)
    return res.data as any
  }
}
